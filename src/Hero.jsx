            ...
            <div className="flex items-center w-full lg:w-1/2">
                <div className="max-w-2xl mb-8">
                    ...
                    <div className="flex flex-col items-start space-y-3 sm:space-x-4 sm:space-y-0 sm:items-center sm:flex-row">
                        <link_1.default href="https://web3templates.com/templates/nextly-landing-page-template-for-startups" target="_blank" rel="noopener" className="px-8 py-4 text-lg font-medium text-center text-white bg-primary rounded-md ">
                            Get Started Now
                        </link_1.default>
                    </div>
                </div>
